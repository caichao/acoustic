...
public class DSP
{
    ...
    public static int[] xcorr(short[] a, short[] b)
    {
        int len = a.length;
        if (b.length > a.length)
            len = b.length;
    ...
    // a fast version of xcorr, just use short value to improve speed
    public static int[] xcorr(short[] a, short[] b, int maxlag)
    {
        int[] y = new int[2 * maxlag + 1];
