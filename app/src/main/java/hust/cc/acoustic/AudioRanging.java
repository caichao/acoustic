...
public class AudioRanging extends AppCompatActivity implements AudioRecorder.RecordingCallback{
    ...
    // Non UI variable
    private String TAG = AudioRanging.class.getSimpleName();
    private short[] mPCM;
    ...
    void setmSaveButton(){
        ...
        if(name != null && !name.equals("")){
            AudioRanging.FileInfo fileInfo = new AudioRanging.FileInfo();
            fileInfo.name = name;
            ...
            new AudioRanging.SaveAndUpdateUI().execute(fileInfo);
        }else {
            /*if(mToast != null){
                mToast.cancel();
    ...
    private class SaveAndUpdateUI extends AsyncTask<AudioRanging.FileInfo, Integer, Boolean> {
        @Override
        ...
        @Override
        protected Boolean doInBackground(AudioRanging.FileInfo... fileInfos) {
